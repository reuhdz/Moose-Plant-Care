...
const PLANTS = {
  ...
  monstera: {
    ...
    conditions: {
      light:        { ideal: "Bright, indirect — 6+ hrs near a bright window, or 150–250 µmol m⁻² s⁻¹ LED 12–14 hrs", passing: "Medium indirect; lower light = fewer/smaller fenestrations" },
    ...
    tips: {
      lighting: "Bright, indirect light produces the largest leaves and the most fenestrations (the iconic splits and holes). Tolerates medium light but grows slowly with smaller, less-split leaves.\n\n• Avoid harsh direct afternoon sun — leaves burn.\n• Early morning sun (east window) is great.\n• Rotate the pot 1/4 turn every 2 weeks so all vines get even light.\n\nGROW LIGHT (main plant has access — Aug 2026):\nUniversity of Minnesota Extension lists Monstera deliciosa as a MEDIUM-LIGHT foliage houseplant and publishes fixture rules (reviewed 2026).\n\n• TARGET INTENSITY at the leaf canopy: 150–250 µmol m⁻² s⁻¹ PPF/PPFD (about 250–1,000 foot-candles) — UMN's medium-light band. Stay toward the bright end after the Aug chops so remaining leaves keep splitting and axillary buds break. Much hotter (a high-output board a few inches from a leaf) bleaches and scorches.\n• DISTANCE: hang the fixture 12–24\" above the tallest remaining leaf (UMN foliage-houseplant distance). Start ~18–24\" and move closer only if new leaves stay small or unsplit. Inverse-square rule: doubling the distance quarters the PPFD at the leaf — measure at the canopy, not at the bulb.\n• PHOTOPERIOD: 12–14 hours/day on a timer (UMN foliage houseplants). Never 24/7 — plants need a dark stretch for respiration. Central Texas summer window light already covers a lot of the day; use the lamp as a supplement (for example 4–6 extra hours) rather than stacking a full 14 hours on top of a bright window unless the room is dim.\n• SPECTRUM: full-spectrum / white-balanced LED, or blue/mixed light for non-flowering foliage (UMN). Prefer LED — efficient, long-lived, low heat vs incandescent or HPS.\n• HEAT / BURN CHECK: if a leaf feels warm, pales, or curls toward the lamp, raise the fixture 4–6\". Pale stretch + long internodes = too far or too few hours.\n• AIR LAYERS: keep the four sphagnum wraps out of a hot beam; the lamp should light leaves, not cook plastic-wrapped moss.\n• WATERING: a stronger lamp can dry the 13.5\" pot a day sooner — still use the chopstick; don't shorten the calendar automatically.\n\n• In this home, the 1F Living Room corner (vaulted dual NE/SE light) and 1F Bathroom (set back from the SE beam) are your best matches per PLANT_LIGHT_REF. Aim the grow light at the remaining canopy in whichever of those spots the plant lives.",
    ...
    sources: [
      ...
      { label: "University of Minnesota Extension — Lighting for indoor plants", url: "https://extension.umn.edu/planting-and-growing-guides/lighting-indoor-plants" }
    ]
  },
  ...
  assorted_cacti: {
    ...
    repotSigns: [
      ...
      "The green Hylocereus rootstock (from the missing Moon Cactus) has GROWN in length or the new apical shoot is crowding the other two — needs more root room proportionally",
    ...
    names: {
      common: [
        ...
        "Hylocereus rootstock (Dragon Fruit Cactus — new apical growth after scion removed) × 1",
        "Spiny Pincushion Cactus (cluster of 4 heads) × 1"
      ],
      scientific: "1× Gymnocalycium mihanovichii (grafted Moon Cactus, intact) + 1× Hylocereus undatus rootstock (colored scion removed; new green apical growth at the cut) + 1× Mammillaria spinosissima (clustering form, 4 heads)"
    },
    ...
    wateringDaysCool: 35,
    currentSoilMix: "cactus_mix",
    comments: "🌵 Three specimens in a mixed 7\" planter (50/50 cacti mix + perlite, repotted within last 2 months):\n\n1. 1× Gymnocalycium mihanovichii (Moon Cactus, the still-intact one) — colored top grafted onto a Hylocereus rootstock. Healthy.\n2. 1× Hylocereus undatus ROOTSTOCK — the other Moon Cactus's colored Gymnocalycium head was cut off. Aug 2026: NEW GROWTH is now showing at the cut top. That is the expected, healthy response. UF/IFAS pitaya (HS1068): topping a Hylocereus stem induces branching; the green rootstock photosynthesizes on its own and resumes dragon-fruit habit. The new shoot will be GREEN (chlorophyll-bearing), not a neon colored ball. You can (a) let it grow as a standalone dragon-fruit cactus, (b) keep one strong leader and pinch extras, or (c) still use the stalk as a graft base for another colored top — do that soon, before the new shoot occupies the cut face.\n3. 1× Mammillaria spinosissima — clustering cluster of 4 heads. Healthy.\n\n📌 The orphaned rootstock can still serve as a fresh graft base if you want another colored Gymnocalycium top. See pruning/propagation tips.",
    idealSoil: ["cactus_mix"],
    ...
    sources: [
      ...
      { label: "The Spruce — How to Grow Moon Cactus (Ruby Ball)", url: "https://www.thespruce.com/grow-grafted-ruby-ball-cactus-1902604" },
...
const PLACEMENT_SOURCES = [
  ...
  { label: "Clemson HGIC — Indoor Plants: Transplanting & Repotting", url: "https://hgic.clemson.edu/factsheet/indoor-plants-transplanting-repotting/" },
  { label: "University of Minnesota Extension — Lighting for indoor plants", url: "https://extension.umn.edu/planting-and-growing-guides/lighting-indoor-plants" },
  { label: "UF/IFAS HS1068 — Pitaya (Dragonfruit) in the Florida Home Landscape", url: "https://edis.ifas.ufl.edu/publication/HS1068" }
];
...
const PLANT_LIGHT_REF = {
  ...
  monstera:                   { light: "Bright indirect + grow light",            humidity: "High 60%+",             best: "1F Corner, 1F Bath — grow light 12–24\" / 12–14h", hum: true },
  ...
  assorted_cacti:             { light: "Bright, mostly direct 4h+",              humidity: "Low 20–40%",            best: "2F LR (SW) — Hylocereus new apical growth" },
